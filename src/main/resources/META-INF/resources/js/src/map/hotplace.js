...
(function(hotplace, $) {
	...
	*/
    ...
    hotplace.config = {
    	...
    	codes: {
    		...
    		yongdoJiyeog: {
    			...
    			'jeonyongJugeo':{name:'전용주거지역', value:'전용주거지역'},
    			'firstJeonyongJugeo':{name:'제1종전용주거지역', value:'제1종전용주거지역'},
    			'secondJeonyongJugeo':{name:'제2종전용주거지역', value:'제2종전용주거지역'},
    			'ilbanJugeo':{name:'일반주거지역', value:'일반주거지역'},
    			'firstIlbanJugeo':{name:'제1종일반주거지역', value:'제1종일반주거지역'},
    			'secondIlbanJugeo':{name:'제2종일반주거지역', value:'제2종일반주거지역'},
    			'thirdIlbanJugeo':{name:'제3종일반주거지역', value:'제3종일반주거지역'},
    			'junjugeo':{name:'준주거지역', value:'준주거지역'},
    			//'sangeob':{name:'상업지역', value:'상업지역'},
    			'jungsimSangeob':{name:'중심상업지역', value:'중심상업지역'},
    			'ilbanSangeob':{name:'일반상업지역', value:'일반상업지역'},
    			'geunlinSangeob':{name:'근린상업지역', value:'근린상업지역'},
    			'yutongSangeob':{name:'유통상업지역', value:'유통상업지역'},
    			//'gongeob':{name:'공업지역', value:'공업지역'},
    			'jeonyongGongeob':{name:'전용공업지역', value:'전용공업지역'},
    			'ilbanGongeob':{name:'일반공업지역', value:'일반공업지역'},
    			'junGongeob':{name:'준공업지역', value:'준공업지역'},
    			//'nogji':{name:'녹지지역', value:'녹지지역'},
    			'bojeonNogji':{name:'보전녹지지역', value:'보전녹지지역'},
    			'saengsanNogji':{name:'생산녹지지역', value:'생산녹지지역'},
    			'natureNogji':{name:'자연녹지지역', value:'자연녹지지역'},
    			'mibunlyu':{name:'용도지역 미분류', value:'용도지역 미분류'},
    			//'gwanli':{name:'관리지역', value:'관리지역'},
    			'gyehoegGwanli':{name:'계획관리지역', value:'계획관리지역'},
    			'saengsanGwanli':{name:'생산관리지역', value:'생산관리지역'},
    			'bojeonGwanli':{name:'보전관리지역', value:'보전관리지역'},
    		...
    		yongdoJigu: {
    			...
    			'watersideGyeonggwan':{name:'수변경관지구', value:'수변경관지구'},
    			'sigajiGyeonggwan':{name:'시가지경관지구', value:'시가지경관지구'},
    			'natureGyeonggwan':{name:'자연경관지구', value:'자연경관지구'},
    			'godo':{name:'고도지구', value:'고도지구'},
    			'highestGodo':{name:'최고고도지구', value:'최고고도지구'},
    			'lowestGodo':{name:'최저고도지구', value:'최저고도지구'},
    			'migwan':{name:'미관지구', value:'미관지구'},
    			'historyMunhwaMigwan':{name:'역사문화미관지구', value:'역사문화미관지구'},
    			'ilbanMigwan':{name:'일반미관지구', value:'일반미관지구'},
    			'gongyongBoho':{name:'공용시설보호지구', value:'공용시설보호지구'},
    			'gonghangBoho':{name:'공항시설보호지구', value:'공항시설보호지구'},
    			'siseolBoho':{name:'시설보호지구', value:'시설보호지구'},
    			'schoolBoho':{name:'학교시설보호지구', value:'학교시설보호지구'},
    			'harborBoho':{name:'항만시설보호지구', value:'항만시설보호지구'},
    			'bangjae':{name:'방재지구', value:'방재지구'},
    			'banghwa':{name:'방화지구', value:'방화지구'},
    			'bojon':{name:'보존지구', value:'보존지구'},
    			'munhwaBojeon':{name:'문화자원보존지구', value:'문화자원보존지구'},
    			'ecosystemBojon':{name:'생태계보존지구', value:'생태계보존지구'},
    			'importantSiseolBojon':{name:'중요시설물보존지구', value:'중요시설물보존지구'},
    			
    		
    			'apartment':{name:'아파트지구', value:'아파트지구'},
    			
    			
    			'natureChwilag':{name:'자연취락지구', value:'자연취락지구'},
    		...
    		mulgeonKind: {
    			...
    			'eobmoo':{name:'업무 및 상업용', value:''},
    			'toji':{name:'토지(농지,임야 등)', value:''},
    			'gongchang':{name:'공장/창고', value:''},
    			'etc':{name:'기타(종교용지,구거 등)', value:''},
    		},
    		jiga: {
    			'm1000':{name:'1천만원 미만', value:'m1000'},
    			'1000TO5000':{name:'1천만원~5천만원', value:'1000|5000'},
    			'5000TO10000':{name:'5천만원~1억', value:'5000|10000'},
    			'10000TO30000':{name:'1억~3억', value:'10000|30000'},
    			'30000TO50000':{name:'3억~5억', value:'30000|50000'},
    			'50000TO100000':{name:'5억~10억', value:'50000|100000'},
    			'100000TO200000':{name:'10억~20억', value:'100000|200000'},
    			'M200000':{name:'20억 이상', value:'M200000'}
    		},
    		minibchalratio:{
    			"M100":{name:'100% 이상', value:'M100'},
    			"100TO75":{name:'100~75%', value:'75|100'},
    			"75TO50":{name:'75~50%', value:'50|75'},
    			"50TO25":{name:'50~25%', value:'25|50'},
    			"m25":{name:'25% 미만', value:'m25'}
    		}
    	}
    }
	...
	hotplace.processAjaxError = function(errCode, msg) {
		switch(errCode) {
		case _err.LOGIN :
			hotplace.dom.showAlertMsg(hotplace.dom.showLoginForm, msg || '로그인후 사용하세요.');
			break;
		case _err.DUP_LOGIN :
		...
		case _err.WRONG_ACCOUNT :
			...
			break;
		case _err.DUP_ID :
			hotplace.dom.showAlertMsg(null, msg || '중복된 아이디입니다.', {width:'30%'});
			break;
		case _err.JOIN :
			hotplace.dom.showAlertMsg(null, msg || '회원가입도중 오류가 발생했습니다.', {width:'40%'});
			break;
		case _err.USER_MOD :
			hotplace.dom.showAlertMsg(null, msg || '회원정보 수정중 오류가 발생했습니다.', {width:'40%'});
			break;
		case _err.UPLOAD:
			hotplace.dom.showAlertMsg(null, msg || '파일업로드중 에러가 발생했습니다.', {width:'40%'});
			break;
		case _err.MAEMUL_REG:
			hotplace.dom.showAlertMsg(null, msg || '매물등록중 에러가 발생했습니다.', {width:'40%'});
			break;
		...
		case _err.GWANSIM_REG:
			hotplace.dom.showAlertMsg(null, msg || '관심물건 등록중 에러가 발생했습니다.', {width:'40%'});
			break;
		case _err.GWANSIM_DUP:
			hotplace.dom.showAlertMsg(function() {
				hotplace.dom.closeModal();
			}, msg || '이미 등록된 관심물건입니다.', {width:'40%'});
			break;
		case _err.GWANSIM_DEL:
			hotplace.dom.showAlertMsg(function() {
				hotplace.dom.closeModal();
			}, msg || '관심물건이 삭제 되지 않았습니다.', {width:'40%'});
			break;
		case _err.GWANSIM_MOD:
			hotplace.dom.showAlertMsg(null, msg || '관심물건 수정중 에러가 발생했습니다.', {width:'40%'});
			break;
		case _err.CONSULTING_REG:
			hotplace.dom.showAlertMsg(null, msg || '컨설팅요청 등록중 에러가 발생했습니다.', {width:'40%'});
			break;
		case _err.CONSULTING_DUP:
			hotplace.dom.showAlertMsg(function() {
				hotplace.dom.closeModal();
			}, msg || '이미 요청된 컨설팅입니다.', {width:'40%'});
			break;
		...
		case _err.MISS_LATLNG:
			hotplace.dom.showAlertMsg(null, msg || '위경도 정보가 존재하지 않습니다.', {width:'50%'});
			break;
